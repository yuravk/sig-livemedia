...
#url --url=https://x86-64-pungi-10.almalinux.dev/almalinux/10/$basearch/latest_result_almalinux/compose/BaseOS/$basearch/os/
...
#repo --name="crb" --baseurl=https://x86-64-pungi-10.almalinux.dev/almalinux/10/$basearch/latest_result_almalinux/compose/CRB/$basearch/os/
