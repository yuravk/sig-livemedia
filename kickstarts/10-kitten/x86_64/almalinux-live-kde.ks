...
EOF
# # Login screen wallpapers
# themes_conf=/usr/share/sddm/themes
# mkdir -p ${themes_conf}/01-breeze-fedora ${themes_conf}/breeze/
# cat <<'EOF'>${themes_conf}/01-breeze-fedora/theme.conf.user
# [General]
# background=/usr/share/backgrounds/almalinux-day.jpg
# type=image
# EOF
# # Copy for the breeze theme as well
# /bin/cp -av ${themes_conf}/01-breeze-fedora/theme.conf.user ${themes_conf}/breeze/
