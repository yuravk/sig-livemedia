...
url --url=https://x86-64-pungi-9.almalinux.dev/almalinux/9/x86_64/latest_result_almalinux/compose/BaseOS/x86_64/os/
#repo --name="appstream" --baseurl=https://atl.mirrors.knownhost.com/almalinux/9/AppStream/$basearch/os/
repo --name="appstream" --baseurl=https://x86-64-pungi-9.almalinux.dev/almalinux/9/x86_64/latest_result_almalinux/compose/AppStream/x86_64/os/
#repo --name="extras" --baseurl=https://atl.mirrors.knownhost.com/almalinux/9/extras/$basearch/os/
repo --name="extras" --baseurl=https://x86-64-pungi-9.almalinux.dev/almalinux/9/x86_64/latest_result_almalinux/compose/extras/x86_64/os/
#repo --name="crb" --baseurl=https://atl.mirrors.knownhost.com/almalinux/9/CRB/$basearch/os/
repo --name="crb" --baseurl=https://x86-64-pungi-9.almalinux.dev/almalinux/9/x86_64/latest_result_almalinux/compose/CRB/x86_64/os/
